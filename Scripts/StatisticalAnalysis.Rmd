...
ps_adonis<-function(physeq){
  ...
  vegan::adonis2(physeq_dist ~ pH + Treatment + Timepoint, data = md_tab, permutations = 100)
}
...
pairwiseAdonis::pairwise.adonis(x = physeq_dist, factors = md_tab$Treatment, p.adjust.m = "fdr", perm = 100)
}
